...
let t1 = new Task('Reading time',new Date(Date.UTC(2021, 3, 29, 3, 23)),false);
let t2 = new Task('Write up completion',new Date(Date.UTC(2021, 1, 24, 4, 00)),true);
let t3 = new Task('Car wash',new Date(Date.UTC(2021, 2, 22, 12, 15)),false);
let tasks1 = [t1,t2,t3];
